...
public:
    ...
    //
    WordLadder(std::string lexiconFileName, int len);

    //---------------------------------------------------------------------------------------------
    // Destructor for garbage collections -- basically removes all values in the lexicon set
    //
    ~WordLadder();
    ...
    //
    std::vector<std::string> getMinLadder(std::string start, std::string end);
    ...
    //
    void displayResult(std::vector<std::string> sequence);


private:

    std::set<std::string> lexicon;    // The dictionary
    ...
    //
    //
    int findInVector(std::vector<std::string> vec, std::string);
    ...
    //
    bool isWordLadder(std::vector<std::string> sequence);
    ...
    //
    std::set<std::string> getNeighbors(std::string word);
